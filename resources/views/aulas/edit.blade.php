...
@section('content')
    ...
    <div class="row">
                <div class="col-md-12">
                    <h3>Captura Video Pelea</h3>
                    <video id="videoElement" width="400" height="300" autoplay></video>
                </div>
            </div> 
            <div class="card-body">
                <form action="{{ route('aulas.update', $aula->id) }}" method="POST" role="form text-left"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-4">
                            <label for="capacidad" class="form-label">Direccion Colegio</label>
